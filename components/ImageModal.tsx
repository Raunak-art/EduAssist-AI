...
import { Download, Share2, RefreshCw, X, ZoomIn, ZoomOut, Move, RotateCcw, Check } from 'lucide-react';
...
export const ImageModal: React.FC<ImageModalProps> = ({ imageUrl, prompt, onClose, onRecreate, language }) => {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      if (canShareFiles) {
        ...
        alert("Sharing not fully supported on this browser.");
      }
    } catch (error) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/95 backdrop-blur-2xl animate-in fade-in duration-300 overflow-hidden">
